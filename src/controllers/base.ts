...
import { CUSTOM_VALIDATION } from '@src/enums/customs';
...
export abstract class BaseController {
  ...
  private handleClientErrors(error: mongoose.Error.ValidationError): {
    ...
    const duplicatedKindErrors = Object
      .values(error.errors)
      .filter((err) => err instanceof mongoose.Error.ValidatorError && err.kind === CUSTOM_VALIDATION.DUPLICATED)
